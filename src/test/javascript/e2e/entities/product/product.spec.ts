...
describe('Product e2e test', () => {
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      productUpdatePage.setIDproductInput('5'),
      productUpdatePage.setIDmenuInput('5'),
      productUpdatePage.setNameInput('name'),
      productUpdatePage.setPriceInput('5'),
      productUpdatePage.setDisponibilityInput('5'),
      productUpdatePage.menuSelectLastOption()
    ]);

    expect(await productUpdatePage.getIDproductInput()).to.eq('5', 'Expected iDproduct value to be equals to 5');
    expect(await productUpdatePage.getIDmenuInput()).to.eq('5', 'Expected iDmenu value to be equals to 5');
    ...
    expect(await productUpdatePage.getDisponibilityInput()).to.eq('5', 'Expected disponibility value to be equals to 5');
